...
class dualview_model(nn.Module):
    def __init__(self):
        super(dualview_model, self).__init__()
...
class dualview_severity(nn.Module):
    def __init__(self):
        super(dualview_severity, self).__init__()
        self.wave_feature_extraction = wave_view_model1()
        self.spec_feature_extraction = spec_view_model1()
        self.dp1 = nn.Dropout(0.3)
        # self.fc1 = nn.Linear(256*2,128)
...
class dualview_aggregation_model(nn.Module):
    def __init__(self):
        super(dualview_aggregation_model, self).__init__()
...
class aggregation_dualview_severity(nn.Module):
    def __init__(self):
        super(aggregation_dualview_severity, self).__init__()
        self.wave_feature_extraction = wave_view_model2()
        self.spec_feature_extraction = spec_view_model2()
        self.dp1 = nn.Dropout(0.3)
        self.fc1 = nn.Linear(256 * 6, 256)
